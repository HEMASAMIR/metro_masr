...
class _AttractionDetailPageState extends State<AttractionDetailPage>
    ...
    _quickQuestions =
        {
          ...
          'fr': [
            ...
            'Comment y aller depuis le métro?',
            'Convient aux enfants?',
            'Meilleure heure de visite?',
          ],
          'de': [
        ...
        ['What are the highlights?', 'How to get there?'];
  }
  ...
  void _addSystemMessage() {
    ...
    final greeting =
        {
          'ar':
              'مرحباً! 👋 أنا رفيق الذكي، دليلك السياحي للـ $name. كيف أقدر أساعدك؟',
          'en':
              'Hello! 👋 I\'m Rafiq AI, your smart guide for $name. How can I help you?',
          'fr':
              'Bonjour! 👋 Je suis Rafiq AI, votre guide pour $name. Comment puis-je vous aider?',
          'de':
              'Hallo! 👋 Ich bin Rafiq AI, Ihr Guide für $name. Wie kann ich Ihnen helfen?',
        }[widget.lang] ??
        'Hello! I\'m Rafiq AI, your guide for $name.';
  ...
  String _generateAiResponse(String question) {
    ...
    if (q.contains('highlights') ||
        q.contains('أبرز') ||
        q.contains('مميز') ||
        q.contains('points forts') ||
        q.contains('highlights')) {
                  ...
                  Padding(
                    ...
                    child: SizedBox(
                      ...
                      child: ElevatedButton.icon(
                        ...
                        onPressed: () {
                          final query = Uri.encodeComponent('$name egypt');
                          final url =
                              a.wikiUrl ??
                      ...
                      if (images.length > 1)
                        Row(
                          ...
                          children: List.generate(images.length, (i) {
                            final isActive = i == _currentGalleryIndex;
  ...
  Widget _quickInfoItem(
    ...
    child: Column(
      children: [
        ...
        Text(
          label,
          style: const TextStyle(color: Color(0xFF556080), fontSize: 10),
        ),
      ],
    ),
  );
  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      builder: (_, _) => Container(
        ...
        decoration: BoxDecoration(
          color: Colors.grey.withValues(alpha: 0.3 + 0.7 * _ctrl.value),
